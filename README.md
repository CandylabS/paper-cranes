...
<p>Bird color is mapped to timbre, which is generated by Tone.Instrument synthesizer (such as PluckSynth, MembraneSynth, MetalSynth etc).</p>
<p>Background color gradient represent for “key”s. An average brightness of above 0.5 in Major, and brightness of below 0.5 in Minor. Hues in radius represent for C, D, G or A, etc. Adding premade melody loops to the scene is an acceptable way to make music richer.</p>
* <b>User Control</b>:
